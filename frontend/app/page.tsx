      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-balance mb-6">
            Design Your Perfect{" "}
            <span className="text-primary">Custom T-Shirt</span>
          </h1>
          <p className="text-xl text-muted-foreground text-pretty mb-8 max-w-2xl mx-auto">
            Create unique, one-of-a-kind merchandise with our powerful design
            tools. Use AI generation, add custom text, or upload your own
            images.
          </p>
          ...
          {user ? (
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" asChild className="text-lg px-8">
                  <Link href="/design">
                    继续设计 <ArrowRight className="w-5 h-5 ml-2" />
                  </Link>
                </Button>
                <Button
                  size="lg"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild className="text-lg px-8">
                <Link href="/auth">
                  开始设计 <ArrowRight className="w-5 h-5 ml-2" />
                </Link>
              </Button>
              <Button
                size="lg"
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Describe your vision and let AI create stunning designs for
                  you
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Add custom text with beautiful fonts and colors
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="text-sm text-muted-foreground space-y-2">
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Upload your own images and artwork for complete control
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="text-sm text-muted-foreground space-y-2">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Select your T-shirt style, color, and size from our premium
                  collection
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Use our powerful editor to create your perfect design with AI,
                  text, or images
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Review your design, place your order, and receive your custom
                  T-shirt
                </p>
              </div>
            </div>
      ...
      <section className="py-20 px-4 bg-primary text-primary-foreground">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Join thousands of creators who have designed their perfect custom
            T-shirts
          </p>
